...
const OrderSummary = ({totalPrice, totalDiscount = 0}:OrderSummaryProps) => {
  ...
  return (
    <div className="text-white rounded-xl p-3 sm:p-4 shadow-xl flex flex-col min-h-[400px] lg:min-h-[500px]" style={{ background: 'linear-gradient(to bottom right, #0D47A1, #1565C0)' }}>
      {/* Header */}
      ...
      <div className="space-y-2 sm:space-y-2.5 mb-4 sm:mb-6 flex-shrink-0">
        ...
        {totalDiscount > 0 && (
          <div className="flex justify-between items-center py-1 sm:py-1.5 border-b" style={{ borderColor: 'rgba(255, 255, 255, 0.2)' }}>
            <span className="text-xs sm:text-sm" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>Discount</span>
      ...
      <div className="space-y-3 sm:space-y-4 flex-shrink-0 pt-4 border-t" style={{ borderColor: 'rgba(255, 255, 255, 0.2)' }}>
        {/* Total - Prominent */}
