...
export const products: Product[] = [
  {
    ...
    Description: "No sales pitch. No wasted time. Just a focused strategy session to give you clarity and direction for your LSAT prep.",
  },
  {
    id: 5,
    price: 125,
    ...
    assignedEmployeeId: 1,
    DateTime: [], // Add this line
    Description: "Need flexibility? Book individual LSAT tutoring sessions as you go",
  },
  {
    id: 6,
    price: 577,
