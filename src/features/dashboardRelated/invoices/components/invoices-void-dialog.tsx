    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-lg'>
        ...
        <Alert variant='destructive'>
          ...
          <AlertDescription>
            You are about to void invoice #{currentRow.invoiceNumber} for customer {currentRow.customerName} 
            with a total value of {formatCurrency(currentRow.amount)}. This action cannot be undone.
          </AlertDescription>
        </Alert>
