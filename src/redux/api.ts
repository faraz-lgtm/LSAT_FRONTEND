...
export const api = createApi({
  ...
  tagTypes: ["Orders", "Users", "AvailableSlots", "Products", "Tasks", "Dashboard", "Invoices", "Refunds", "Transactions", "Currency", "Automation", "Chat", "Organization", "Calendar", "SuperAdminStats", "SuperAdminUsage"],
